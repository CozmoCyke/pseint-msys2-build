...
static void EncodingProbe() {
	...
	std::fprintf(stderr, u8LocalizationManager::Instance().Translate("ENCODING TEST fprintf: Definir Reel Caractere\\n"));
	std::cout << u8LocalizationManager::Instance().Translate("ENCODING TEST cout: Definir Reel Caractere") << std::endl;
}
