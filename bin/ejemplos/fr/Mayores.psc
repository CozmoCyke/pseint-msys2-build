...
{Proceso} Mayores
	...
	Escribir "Entrez le nombre de données (de 2 à 200) :"{;}
	Leer n{;}
	
	// read the data one par one and store them in the array
	Para i<-{1#0} Hasta {n#n-1} Hacer
		Escribir "Entrez la donnée ",{i#i+1},":"{;}
		Leer datos[i]{;}
	FinPara
	...
	// show the results
	Escribir "The largest est : ",may1{;}
	Escribir "The second largest est : ",may2{;}
