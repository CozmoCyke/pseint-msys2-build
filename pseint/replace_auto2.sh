...
def usage():
    ...
    print('  replace_auto --stat <fichier.cpp>')
...
if cmd == "--stat":
    ...
    done_total = done1 + done2 + done3
    raw_total = raw1 + raw2 + raw3
    total = done_total + raw_total
    ...
    print()
    print("=== TOTAL ===")
    print(f"Déjà traduites   : {done_total}")
    print(f"Encore à traiter : {raw_total}")
    print(f"Total détecté    : {total}")
    print(f"Avancement       : {pct(done_total, total)}")
    print()
    print("=== PAR CATÉGORIE ===")
    print("Catégorie 1 : SyntaxError(..., \"...\")")
    print(f"  déjà traduites   : {done1}")
    print(f"  encore à traiter : {raw1}")
    print(f"  total            : {done1 + raw1}")
    print(f"  avancement       : {pct(done1, done1 + raw1)}")
    print()
    print("Catégorie 2 : ExecutionError / CompileTimeWarning / Warning")
    print(f"  déjà traduites   : {done2}")
    print(f"  encore à traiter : {raw2}")
    print(f"  total            : {done2 + raw2}")
    print(f"  avancement       : {pct(done2, done2 + raw2)}")
    print()
    print("Catégorie 3 : MkErrorMsg(\"...\", ...)")
    print(f"  déjà traduites   : {done3}")
    print(f"  encore à traiter : {raw3}")
    print(f"  total            : {done3 + raw3}")
    print(f"  avancement       : {pct(done3, done3 + raw3)}")
